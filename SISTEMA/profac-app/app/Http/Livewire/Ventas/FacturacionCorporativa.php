...
class FacturacionCorporativa extends Component
{
    ...
    public function imprimirFacturaCoorporativa($idFactura)
    {
        ...
        *
        ...
        $pdf = PDF::loadView('/pdf/factura', compact('cai', 'cliente', 'importes', 'productos', 'numeroLetras', 'importesConCentavos', 'flagCentavos', 'ordenCompra', 'precioDolar'))->setPaper('letter');
