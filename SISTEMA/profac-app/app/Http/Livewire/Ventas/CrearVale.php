...
///////////////////////////////////////////////////////////////////////
        ...
        return view('livewire.ventas.crear-vale',compact('idFactura'));
    }
    ...
    public function datosFactura(Request $request)
    {
        try {
            ...
            ->select('factura.*', 'tipo_pago_venta.descripcion as tipo_pago','cliente.nombre','cliente.rtn','users.name', 'estado_venta.descripcion as estado_venta')  

            ->where('factura.id', '=', $request->idFacturaVale)

            ->get();

            //$datos = DB::SELECTONE("select id,nombre, rtn, dias_credito from cliente where id = " . $request->idFacturaVale);
    ...
    public function guardarVenta(Request $request)
    {
        try {
            ...
            if ($estado == 1) 
            {
                ...
                //////////////////////////////////////////////////////Aqui debe guardarse primero el vale//////////////////////////
            ...
            ////////////////////////////////////////////////////Aqui debe guardarse los productos has vale
