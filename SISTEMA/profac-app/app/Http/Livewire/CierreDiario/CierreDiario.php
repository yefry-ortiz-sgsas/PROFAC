    ...
    public function contado($fecha){
        try {
            ...
            $consulta = DB::SELECT("
                ...
                IF(
                    (select COUNT(*) from tipo_cobro_cierre where factura = A.cai) = 0, 'SIN ASIGNAR', (select tipo_cobro_cierre.textoCobro from tipo_cobro_cierre where factura = A.numero_factura AND estado = 1)
                    ) as 'PagoMediante'
                from factura A
