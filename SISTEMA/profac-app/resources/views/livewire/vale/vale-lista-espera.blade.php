<div>
                    ...
                    <div class="ibox-content">
                            ...
                            <div class="row">
                                ...
                                <div class="form-group col-12 col-sm-12 col-md-3 col-lg-2 col-xl-2">
                                    ...
                                    <input id="subTotalGeneral" name="subTotalGeneral" type="hidden" value="0"
                                        required>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                ...
                                <div class="form-group col-12 col-sm-12 col-md-3 col-lg-2 col-xl-2">
                                    <input type="text" placeholder="ISV " id="isvGeneralMostrar"
                                        ...
                                        autocomplete="off" readonly>
                                    <input id="isvGeneral" name="isvGeneral" type="hidden" value="0" required>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                ...
                                <div class="form-group col-12 col-sm-12 col-md-3 col-lg-2 col-xl-2">
                                    ...
                                    <input id="totalGeneral" name="totalGeneral" type="hidden" value="0"
                                        required>
                                </div>
                            </div>
        ...
        <div class="ibox ">
            ...
            <div class="ibox-content">
                ...
                <div class="row">
                    ...
                    <div class="form-group col-12 col-sm-12 col-md-2 col-lg-1 col-xl-1">
                        <label class="col-form-label" for="subTotalGeneralMostrarVP">Sub Total L.<span
                                class="text-danger">*</span></label>
                    </div>

                    <div class="form-group col-12 col-sm-12 col-md-3 col-lg-2 col-xl-2">
                        <input type="text" placeholder="Sub total " id="subTotalGeneralMostrarVP"
                            name="subTotalGeneralMostrarVP" class="form-control" data-parsley-required
                            autocomplete="off" readonly>

                        <input id="subTotalGeneralVP" name="subTotalGeneralVP" type="hidden" value="0"
                            required>
                    </div>
                </div>
                ...
                <div class="row">
                    ...
                    <div class="form-group col-12 col-sm-12 col-md-2 col-lg-1 col-xl-1">
                        <label class="col-form-label" for="isvGeneralMostrarVP">ISV L.<span
                                class="text-danger">*</span></label>
                    </div>
                ...
                <div class="row">
                    ...
                    <div class="form-group col-12 col-sm-12 col-md-2 col-lg-1 col-xl-1">
                        <label class="col-form-label" for="totalGeneralMostrarVP">Total L.<span
                                class="text-danger">*</span></label>
                    </div>

                    <div class="form-group col-12 col-sm-12 col-md-3 col-lg-2 col-xl-2">
                        <input type="text" placeholder="Total  " id="totalGeneralMostrarVP"
                            name="totalGeneralMostrarVP" class="form-control" data-parsley-required
                            autocomplete="off" readonly>
    ...
    <div class="wrapper wrapper-content animated fadeInRight">
        <div class="ibox ">
            <div class="ibox-title">
                <h3>Valor de Factura + Vale <i class="fa-solid fa-file-invoice-dollar"></i></h3>
            </div>
            <div class="ibox-content">
                <div class="row">

                    <div class="form-group col-12 col-sm-12 col-md-2 col-lg-1 col-xl-1">
                        <label class="col-form-label" for="subTotalGeneralValeMostrar">Sub Total L.<span
                                class="text-danger">*</span></label>
                    </div>

                    <div class="form-group col-12 col-sm-12 col-md-3 col-lg-2 col-xl-2">
                        <input type="text" placeholder="Sub total " id="subTotalGeneralValeMostrar"
                            name="subTotalGeneralValeMostrar" class="form-control" data-parsley-required
                            autocomplete="off" readonly>

                        <input id="subTotalGeneralVale" name="subTotalGeneralVale" type="hidden" value="0"
                            required>
                    </div>
                </div>
                ...
                <div class="row">
                    ...
                    <div class="form-group col-12 col-sm-12 col-md-2 col-lg-1 col-xl-1">
                        <label class="col-form-label" for="isvGeneralValeMostrar">ISV L.<span
                                class="text-danger">*</span></label>
                    </div>

                    <div class="form-group col-12 col-sm-12 col-md-3 col-lg-2 col-xl-2">
                        <input type="text" placeholder="ISV " id="isvGeneralValeMostrar" name="isvGeneralMostrar"
                            class="form-control" data-parsley-required autocomplete="off" readonly>
                        <input id="isvGeneralVale" name="isvGeneralVale" type="hidden" value="0" required>
                    </div>
                </div>
                ...
                <div class="row">
                    ...
                    <div class="form-group col-12 col-sm-12 col-md-2 col-lg-1 col-xl-1">
                        <label class="col-form-label" for="totalGeneralValeMostrar">Total L.<span
                                class="text-danger">*</span></label>
                    </div>

                    <div class="form-group col-12 col-sm-12 col-md-3 col-lg-2 col-xl-2">
                        <input type="text" placeholder="Total  " id="totalGeneralValeMostrar"
                            name="totalGeneralValeMostrar" class="form-control" data-parsley-required
                            autocomplete="off" readonly>

                        <input id="totalGeneralVale" name="totalGeneralVale" type="hidden" value="0" required>
                    </div>
                </div>
        ...
        <script>
                    ...
                    .then(response => {
                       ...
                       let htmlVP = `
                        <div id='VP${numeroInputsVP}' class="row no-gutters">
                                            ...
                                            <input id="restaInventarioVP${numeroInputsVP}" name="restaInventario${numeroInputsVP}" type="hidden" value="">
                                            <input id="isvVP${numeroInputsVP}" name="isv${numeroInputsVP}" type="hidden" value="${producto.isv}">
            ...
            function calcularTotalesVP(idPrecio, idCantidad, isvProducto, idUnidad, id, idRestaInventario) {
                ...
                if (valorInputPrecio && valorInputCantidad) {
                    ...
                    document.getElementById('subTotalVP' + id).value = subTotal.toFixed(3);
            ...
            function totalesGeneralesVP() {
                ...
                for (let i = 0; i < arregloIdInputsVP.length; i++) {
                    subTotalGeneralValor += new Number(document.getElementById('subTotalVP' + arregloIdInputsVP[i]).value);
                ...
                console.log(subTotalGeneralValor);
                ...
                document.getElementById('isvGeneralVP').value = totalISV.toFixed(3);
                document.getElementById('isvGeneralMostrarVP').value = new Intl.NumberFormat('es-HN', {
                    style: 'currency',
                    currency: 'HNL',
                    minimumFractionDigits: 2,
                }).format(totalISV)

                document.getElementById('totalGeneralVP').value = totalGeneralValor.toFixed(3);
                document.getElementById('totalGeneralMostrarVP').value = new Intl.NumberFormat('es-HN', {
                    style: 'currency',
                    currency: 'HNL',
                    minimumFractionDigits: 2,
                }).format(totalGeneralValor)
            ...
            function guardarVenta() {
                ...
                let name = "unidadVP" + arregloIdInputs[i];
                let nameForm = "idUnidadVentaVP" + arregloIdInputs[i];

                let e = document.getElementById(name);
                let idUnidadVenta = e.options[e.selectedIndex].getAttribute("data-id");

                data.append("arregloIdInputsVP[]", arregloIdInputs[i]);
                data.append(nameForm, idUnidadVenta)
                }
            ...
            function sumarTotales() {
               ...
               let subTotalGeneralFactura = document.getElementById('subTotalGeneral').value;       
               let isvGeneralValeFactura = document.getElementById('isvGeneral').value;             
               let totalGeneralValeFactura = document.getElementById('totalGeneral').value;         

               let subTotalGeneralVP = document.getElementById('subTotalGeneralVP').value;
               let isvGeneralVP = document.getElementById('isvGeneralVP').value;
               let totalGeneralVP = document.getElementById('totalGeneralVP').value;

               let sumaSubTotales = parseFloat(subTotalGeneralFactura) + parseFloat(subTotalGeneralVP);
               let sumaISV = parseFloat(isvGeneralValeFactura) + parseFloat(isvGeneralVP);
               let sumaTotal = parseFloat(totalGeneralValeFactura) + parseFloat(totalGeneralVP);
                
              

               document.getElementById("subTotalGeneralVale").value = sumaSubTotales;
               document.getElementById("isvGeneralVale").value = sumaISV;
               document.getElementById('totalGeneralVale').value = sumaTotal;


               document.getElementById('subTotalGeneralValeMostrar').value = new Intl.NumberFormat('es-HN', {
                    style: 'currency',
                    currency: 'HNL',
                    minimumFractionDigits: 2,
                }).format(sumaSubTotales)

                document.getElementById('isvGeneralValeMostrar').value = new Intl.NumberFormat('es-HN', {
                    style: 'currency',
                    currency: 'HNL',
                    minimumFractionDigits: 2,
                }).format(sumaISV)
                ...
                document.getElementById('totalGeneralValeMostrar').value = new Intl.NumberFormat('es-HN', {
                    style: 'currency',
                    currency: 'HNL',
                    minimumFractionDigits: 2,
                }).format(sumaTotal)
