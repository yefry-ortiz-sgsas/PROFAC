...
<body>
    ...
    <div class="pruebaFondo">
        ...
        <div class="card border border-dark" style="margin-left:44px; margin-top:10px; width:45rem; height:10.5rem;">
            <div class="card-body">
                ...
                <p class="card-text" style="position:absolute;left:520px;  top:10px;"><b>Fecha:</b>
                    {{ $cai->fecha_emision }}</p>
                <p class="card-text" style="position:absolute;left:520px;  top:25px;"><b>Hora:</b> {{ $cai->hora }}
                </p>
                <p class="card-text" style="position:absolute;left:520px;  top:40px;"><b>Vence:</b>
                    {{ $cai->fecha_vencimiento }}</p>
                <p class="card-text" style="position:absolute;left:520px;  top:57px;"><b>RTN:</b> {{ $cliente->rtn }}
                </p>
                <p class="card-text" style="position:absolute;left:520px;  top:72px;"><b>Orden N°:</b>
        ...
        @if(count($productos) <= 10) <div class="card border border-dark" style="position: relative; margin-left:44px; margin-top:10px; width:45rem; page-break-inside: auto;">
            <div>
        ...
        <div>
            ...
            <table class="" style="font-size: 11px; ">
                ...
                <tbody>
                    ...
                    @for ($i = 0; $i < 14; $i++) @php unset($productos[$i]); @endphp @endfor </tbody>
            </table>
        </div>
    </div>
    ...
    @for ($g = 0; $g < $numeroTablas; $g++) @if(count($productos)> 20)
        ...
        <div class="card border border-dark" style="position: relative; margin-left:44px; margin-top:80px; width:45rem; page-break-inside: auto;">
            <div>
                ...
                $p2 =$p2 + $p1;
                @endphp
                @for ($i = $p1; $i < $p2 ; $i++) @php unset($productos[$i]); @endphp @endfor @elseif($vueltasTabla> 1 && $vueltasTabla < $numeroTablas) @php $p2=$p2 + 20; @endphp @for ($i=$p2; $i < $p2 ; $i++) @php unset($productos[$i]); @endphp @endfor @endif </div>
            </div>
            <div style="page-break-after: always"></div>

            @elseif(count($productos) < 20) <div class="card border border-dark" style="position: relative; margin-left:44px; margin-top:80px; width:45rem; page-break-inside: auto;">
                <div>
        ...
        <div style=" position: relative; margin-left:44px; page-break-inside: avoid;">
            <div class="card border border-dark" style="position:absolute;left:0px; margin-top:{{ $altura }}px;   width:26rem; height:15rem;">
                <div class="card-body">
                    ...
                    <p class="card-text" style="position:absolute;left:10px;  top:40px; font-size:11px;">1. por cada
                        cheque
                    ...
                    <p class="card-text" style="position:absolute;left:10px;  top:110px; font-size:11px">5. la firma del
                        cliente o representante en la factura, da por hecho que acepta y obliga a este a cumplir con
                        todas
                    ...
                    <p class="card-text" style="position:absolute;left:10px;  top:205px; font-size:11px">7. las entregas
                        y
                        creditos para cuentas con facturas vencidas serán congeladas hasta el pago de las mismas haya
                        sido
                        efectuado en su totalidad.

                        @if ($cai->estado_factura == 1)
                        <span style="font-size: 10px">N{{ $cai->numero }}-CF11</span>
                    </p>
                    @else
            ...
            <div class="card border border-dark" style="position:absolute;left:430px; margin-top:{{ $altura }}px;   width:18rem; height:15rem;">
                <div class="card-body">
                    <div>
                    ...
                    <div>
                        <p class="card-text" style="position:absolute; left:10px;  top:46px; font-size:16px;">Importe
                            Exento: </p>
                        <p class="card-text" style="position:absolute; right:10px;  top:46px; font-size:16px;">0.00
                        </p>
                    </div>
                    ...
                    <p class="card-text" style="position:absolute; right:10px;  top:105px; font-size:16px;">
                        {{ $importesConCentavos->sub_total }}</p>

                    <p class="card-text" style="position:absolute; left:10px;  top:130px; font-size:16px;">Impuesto
                        sobre
                        venta:</p>
                    <p class="card-text" style="position:absolute; right:10px;  top:130px; font-size:16px;">
                    ...
                    <p class="card-text" style="position:absolute; right:10px;  top:185px; font-size:18px;">
                        <b>{{ $importesConCentavos->total }}</b>
                    </p>
                </div>
            </div>


            <div style="left:0px;   width:45rem;">
        ...
        <div>
            <p class="" style="position:absolute; margin-top:{{ $altura2 + 40 }}px;  left:80px;   font-size:50px;">
                --FACTURA ANULADA--</p>
        </div>
        @endif
