...
@endphp
    ...
    <div class="pruebaFondo">
        ...
        <div class="card border border-dark"   style="margin-left:44px; margin-top:10px; width:45rem; height:10.5rem;">
            <div class="card-body">
                <p class="card-text" style="position:absolute;left:20px;  top:10px;"><b>Cliente: </b></p>
                <p class="card-text" style="position:absolute;left:20px;  top:29px;font-size: 9px; max-width:500px"><b>Dirección:</b></p>
                ...
                <p class="card-text" style="position:absolute;left:520px;  top:10px;"><b>Fecha:</b> </p>
                <p class="card-text" style="position:absolute;left:520px;  top:25px;"><b>Hora:</b> </p>
                <p class="card-text" style="position:absolute;left:520px;  top:40px;"><b>Vence:</b> </p>
                <p class="card-text" style="position:absolute;left:520px;  top:57px;"><b>RTN:</b> </p>
        ...
        <div style=" position: relative; margin-left:44px;">
            <div class="card border border-dark" style="position:absolute;left:0px; margin-top:{{$altura}}px;   width:26rem; height:15rem;">
                <div class="card-body">
                    ...
                    <p class="card-text" style="position:absolute;left:10px;  top:205px; font-size:11px">7. las entregas y
                        ...
                        <span style = "font-size: 10px">N-CF11</span></p>
                        @else
                        <span style = "font-size: 10px">N-CF12</span></p>
                        @endif --}}
            ...
            <div class="card border border-dark"
                ...
                <div class="card-body">
                    ...
                    <p class="card-text" style="position:absolute; right:10px;  top:105px; font-size:16px;"></p>
    
                    <p class="card-text" style="position:absolute; left:10px;  top:130px; font-size:16px;">Impuesto sobre
                        venta:</p>
                    <p class="card-text" style="position:absolute; right:10px;  top:130px; font-size:16px;"></p>
                    ...
                    <p class="card-text" style="position:absolute; left:10px;  top:185px; font-size:18px;"><b>Total a
                            Pagar: </b></p>
                    <p class="card-text" style="position:absolute; right:10px;  top:185px; font-size:18px;"><b></b>
                    </p>
                </div>
            </div>
            ...
            <div style="position:absolute;left:0px;  margin-top:{{$altura2}}px;  width:45rem;">
                ...
                <p class="card-text" style="position:absolute;left:450px;  top:10px;">
                    _______________________________________</p>
                <p class="card-text" style="position:absolute;left:80px;  top:25px; "></p>
